...
class NewPizzaDetailsActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.new_activity_pizza_details)

        val pizza = intent.getSerializableExtra("newPizza") as Pizza
